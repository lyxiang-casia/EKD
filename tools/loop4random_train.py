...
def main(cfg, resume, opts, run_id):
    ...
    elif "e" in cfg.DISTILLER.TYPE:
        print(log_msg("Loading teacher model", "INFO"))
        net, pretrain_model_path = cifar_emodel_dict[cfg.DISTILLER.TEACHER]
        assert (
...
if __name__ == "__main__":
    ...
    for run_id in range(5):
        main(cfg, args.resume, args.opts, run_id)
