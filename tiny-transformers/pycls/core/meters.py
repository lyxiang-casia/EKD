...
class TrainMeter(object):
    ...
    def __init__(self, epoch_iters, phase="train"):
        ...
        self.num_top5_mis = 0
        self.num_samples = 0
        self.lamb = ScalarMeter(cfg.LOG_PERIOD)
        self.ekd_loss = ScalarMeter(cfg.LOG_PERIOD)

        self.wandb = cfg.LOG_WANDB
    ...
    def update_stats(self, top1_err, top5_err, cls_loss, inter_loss, logit_loss, loss, lr, mb_size, lamb, ekd_loss):
        ...
        self.lamb.add_value(lamb)
        self.ekd_loss.add_value(ekd_loss)
    ...
    def get_iter_stats(self, cur_epoch, cur_iter):
        ...
        stats = {
            ...
            "lamb": self.lamb.get_win_median(),
            "ekd_loss": self.ekd_loss.get_win_median(),
        }
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        if self.wandb:
            log_dict = {
                'top1_acc': 100.0 - stats['top1_err'],
                'top5_acc': 100.0 - stats['top5_err'],
                'loss': stats['loss'],
                'lr': stats['lr'],
                'lamb': stats['lamb'],
                'ekd_loss': stats['ekd_loss'],
                'cls_loss': stats['cls_loss'],
                'kd_loss': stats['loss'] - stats['ekd_loss'] - stats['cls_loss'],
            }
            wandb.log(log_dict)
...
class TestMeter(object):
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        if self.wandb:
            log_dict = {
                'max_top1_acc': 100 - stats['min_top1_err'],
                'max_top5_acc': 100 - stats['min_top5_err'],
            }
            wandb.log(log_dict)
