...
# EKD distillation options
_C.DISTILLATION.ENABLE_EKD = False
_C.DISTILLATION.KD_WEIGHT = 5.0
_C.DISTILLATION.EKD_WEIGHT = 5.0
_C.DISTILLATION.WARMUP = 30
_C.DISTILLATION.CLS_WEIGHT = 0.5
